...
},{"core-js/library/fn/array/is-array":"../node_modules/core-js/library/fn/array/is-array.js"}],"../src/components/GameBoard.js":[function(require,module,exports) {
"use strict";
...
var GameBoard = function GameBoard() {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    // code
    var gamePieces = document.querySelectorAll('li.game-piece');

    var _iterator = _createForOfIteratorHelper(gamePieces),
        _step;

    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var gamePiece = _step.value;
        gamePiece.addEventListener('click', function (event) {
